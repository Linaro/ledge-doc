...
project = 'LEDGE reference platform user guide'
...
htmlhelp_basename = 'LEDGEuserguide'
...
latex_documents = [
    (master_doc, 'ledge-user-guide.tex', project, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'ledge-user-guide', project, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LEDGE User Guide', project, author, 'LEDGE User Guide',
